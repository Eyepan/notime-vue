...
<template>
  <main
    class="bg-gray-50 dark:bg-gray-900 w-screen h-screen px-6 py-8 text-gray-900 dark:text-white"
  >
    <div class="flex justify-between">
      <div class="flex flex-row items-center">
        ...
        <a
          @click="logout()"
          class="ml-4 font-semibold text-gray-900 dark:text-gray-500 cursor-pointer"
          >Logout</a
        >
      </div>
      ...
      <div v-if="loading" role="status">
        <svg
          aria-hidden="true"
          class="w-8 h-8 mr-2 animate-spin text-gray-200 dark:text-gray-600 fill-blue-600"
          viewBox="0 0 100 101"
          fill="none"
    ...
    <div class="m-5 grid grid-cols-4 gap-4 sm:grid-cols-2 lg:grid-cols-6">
      ...
      >
        <svg
          class="h-10 object-scale-down fill-black dark:fill-white"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
      ...
      <div v-for="notebook in notebooks" :key="notebook.id">
        ...
        >
          <h5
            ...
            class="cursor-pointer mb-2 h-full text-2xl w-5/6 font-bold tracking-tight"
          >
            {{ notebook.title }}
          </h5>
          <div
